/**
 * Maps logical granularity options to human readable labels and their
 * duration in seconds so they can be used both in the UI and unit math.
 */
...
/** Returns `<Select>` options for all supported granularities. */
